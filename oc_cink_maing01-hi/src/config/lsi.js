const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci ocCink",
      en: "About application ocCink",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní ocCink.",
      en: "You can buy your own ocCink.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci ocCink.",
      en: "You don't have rights to initialize this ocCink.",
    },
  },
